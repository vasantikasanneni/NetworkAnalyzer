...
public class PathListGUI extends javax.swing.JFrame {
                ...
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(btnCritical, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel3Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                        ...
                                                        .addComponent(btnClear, javax.swing.GroupLayout.PREFERRED_SIZE, 84, GroupLayout.PREFERRED_SIZE)
                                                        .addGroup(jPanel3Layout.createSequentialGroup()
   ...
   /*private void btnReportActionPerformed(java.awt.event.ActionEvent evt) throws Exception{


        String message = "Enter the Text File Name: ";
    ...
    private void btnRunActionPerformed(java.awt.event.ActionEvent evt) throws Exception{
        ...
        ArrayList<Integer> startNodeDurationList = new ArrayList<>();
        for(int row = 0; row < tblActivityChart.getRowCount(); row++) {
            ...
            if (strDependency.isEmpty()) {
                ...
                startNodeDurationList.add(Integer.parseInt(strDuration));
            }
            if (row == 0)
        ...
        for(int n = 0; n < results.size(); n++){
            ...
            for(int m = 0; m < l.size(); m++){
                if (m == 0) {
                    idx = startNodeList.indexOf(l.get(m));
                    length += startNodeDurationList.get(idx);
                }
                else
        ...
        pw.write("Title of the Document: ");
        pw.write(text);
        pw.write("\n");
        pw.write(dateFormat.format(date));
        ...
        for(int i = 0; i < results.size();i++) {
            ...
            for (int j = 0; j < results.get(i).size(); j++) {
                    pw.write(results.get(i).get(j) + "->");
            }

            pw.write("\n");
        }
        pw.write("\n");
        pw.write("Total Duration: ");
        pw.write("\n");
        for(int k = 0; k < lengths.size();k++){
            pw.write(k+1+": ");
            pw.write(lengths.get(k).toString()+"\n");
        }
        ...
        for(int i = 0; i < activityTableModel.getRowCount();i++) {
            pw.write(i+1+": ");
            for (int j = 0; j < activityTableModel.getColumnCount(); j++){
                pw.write(activityTableModel.getValueAt(i,j).toString()+"         ");
            }
            pw.write("\n");
        }
    ...
    private void btnCriticalActionPerformed(java.awt.event.ActionEvent evt) {
        Graph g = new Graph(tblActivityChart.getRowCount());
        Character begin = 'A', end = 'Z';
        ArrayList<Character> startNodeList = new ArrayList<>();
        ArrayList<Integer> startNodeDurationList = new ArrayList<>();
        ...
        for(int i = 0; i < lengths.size();i++){
            if(lengths.get(i) == max){
                pathTableModel.addRow(new Object[]{results.get(i).toString(), lengths.get(i)});
